...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'history.context_processors.pending_counter_context',
            ],
        },
    },
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "cardgame"),
        "USER": os.environ.get("DB_USER", "cardgame"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "cardgame1234"),
